...
describe('getServiceHealth', () => {
  ...
  describe('a service that cannot be found', () => {
    setup();
  ...
  describe('a service in a single server role', () => {
  ...
  describe('a service with multiple server roles', () => {
    ...
    describe('if slice is \'blue\' or \'green\'', () => {
