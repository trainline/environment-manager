...
var assertContract = function (contract, contractName, contractAssertion) {
  ...
  if (contract === undefined) {
    ...
    if (contractAssertion.type) {
      ...
      if (contractAssertion.type === String) {
        ...
        if (!(contract instanceof contractAssertion.type) &&
            contract.getType &&
            contract.getType() != contractAssertion.type)
    ...
    for (var property in contractAssertion.properties) {
