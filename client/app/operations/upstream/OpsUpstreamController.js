...
angular.module('EnvironmentManager.operations').controller('OpsUpstreamController',
  function ($scope, $routeParams, $location, $uibModal, $q, $http, resources, QuerySync, cachedResources, accountMappingService, modal, UpstreamConfig, localstorageservice, teamstorageservice) {
    var vm = this;
    var querySync;
        ...
        cachedResources.config.environments.all().then(function (environments) {
          ...
          querySync = new QuerySync(vm, {
            environment: {
              ...
              default: localstorageservice.getValueOrDefault(localstorageservice.keys.selections.environment, vm.environmentsList[0])
            },
            cluster: {
