...
angular.module('EnvironmentManager.operations').component('lbServersStatesCell', {
  ...
  controller: function ($sce, $templateRequest, $compile, comparisons, $log) {
    ...
    _.forEach(lbs, function(lb){
      ...
      if(lb.State.Overall === 'Unhealthy')
        html += '<span class="status-error" title="All servers unhealthy"><span class="glyphicon glyphicon-exclamation-sign"></span> Unhealthy (' + lb.State.UnhealthyCount + ')</span>';
